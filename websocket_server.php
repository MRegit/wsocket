...
$allowedIps = explode(',', isset($_ENV['ALLOWED_IPS']) ? $_ENV['ALLOWED_IPS'] : '127.0.0.1');
...
try {
    $host = isset($_ENV['WS_HOST']) ? $_ENV['WS_HOST'] : '127.0.0.1';
    $port = (int)(isset($_ENV['WS_PORT']) ? $_ENV['WS_PORT'] : 8080);
